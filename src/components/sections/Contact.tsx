...
export function Contact() {
  return (
    <section id="contact" className="relative overflow-hidden py-24 sm:py-32" aria-label="Connect">
      <div className="container-page relative">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <Reveal delay={0.06}>
            <p
              className="mx-auto mt-5 max-w-lg text-balance text-base leading-relaxed sm:text-lg"
              style={{ color: 'var(--color-ink-muted)' }}
            >
              Whether it’s tech, design, or just a conversation, feel free to reach out.
            </p>
          </Reveal>
          ...
          <Reveal delay={0.18}>
            <nav
              ...
              className="mt-12 flex flex-wrap items-center justify-center gap-x-6 gap-y-4 sm:gap-x-12 md:gap-x-14"
            >
              {socials.map(({ href, label, icon: Icon }) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="group inline-flex items-center gap-2.5 text-base font-medium tracking-wide text-[var(--color-ink)] transition-all duration-200 hover:-translate-y-0.5 hover:text-[#0A66C2] sm:gap-3 sm:text-lg"
                >
